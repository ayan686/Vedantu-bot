...
BOT_OWNER_ROLE = 'SURYA' # change to what you need
#BOT_OWNER_ROLE_ID = "748154964047822908" 
  
 

 
oot_channel_id_list = ["568617830258442255","747747677596287028","742645972945076234","745169343566053498","748432939733483520","743059900900573185"]
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="HQ TRIVIA",description="", color=0x0ff14)
        self.embed.add_field(name="**__ANSWER 1  __**", value="~~0.0~~", inline=False)
    ...
    async def update_embeds(self):
      #  global wrong
        ...
        self.embed.set_field_at(0, name="**__ANSWER 1  __**",  value="**{0}**{1}".format(lst_scores[0], one_check))
        self.embed.set_field_at(1, name="**__ANSWER 2  __**",  value="**{0}**{1}".format(lst_scores[1], two_check))
        self.embed.set_field_at(2, name="**__ANSWER 3  __**",  value="**{0}**{1}".format(lst_scores[2], three_check))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzA0ODg1NzgxOTE0ODQ1MjQ2.X5Ogpg.-2USN3imMRiBIdoZLIlattrnFOY", "user_settings": {"locale": "en-US", "theme": "dark'))
    loop.run_forever()
